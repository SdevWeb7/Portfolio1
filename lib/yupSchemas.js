...
export const emailSchemas = yup.object().shape({
   email: yup.string().email('Veuillez entrer une adresse e-mail valide').typeError('Veuillez entre une adresse e-mail valide')
})