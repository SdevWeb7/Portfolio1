...
-- AddForeignKey
ALTER TABLE "Video" ADD CONSTRAINT "Video_fromID_fkey" FOREIGN KEY ("fromID") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_toVideoId_fkey" FOREIGN KEY ("toVideoId") REFERENCES "Video"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
